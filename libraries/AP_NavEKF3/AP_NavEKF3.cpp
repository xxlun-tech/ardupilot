...
bool NavEKF3::get_relative_position_NED_origin(Vector3f &vec) const
{
    Vector2f posNE;
    float posD;
...
bool NavEKF3::get_relative_position_NED_origin_2(Vector3f &vec) const
{
    Location loc, orign;
...
bool NavEKF3::get_relative_position_NED_origin_3(Vector3f &vec) const
{
    Location loc, orign;
...
// Return the last calculated latitude, longitude and height in WGS-84
bool NavEKF3::getLastLLH(Location &loc) const
{
    if (!core) {
        return false;
    }
